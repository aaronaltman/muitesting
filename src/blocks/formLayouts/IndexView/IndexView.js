...
import Fluid from '/src/layouts/Fluid';
import Container from '/src/components/Container';

import ResizableFrame from 'src/components/ResizableFrame';
      ...
      <Box bgcolor={'alternate.main'}>
        <Container maxWidth={1500} paddingBottom={'16px !important'}>
          <Breadcrumbs aria-label="breadcrumb">
            <Link underline="hover" color="inherit" href="/thefront-main/nextjs/src/pages/blocks">
              Components
            </Link>
            <Link
              underline="hover"
              color="inherit"
              href="/thefront-main/nextjs/src/pages/blocks#js--blocks__index-section--application-ui"
            >
              Application UI
            </Link>
